...
\markdownRendererUlItem \markdownRendererStrongEmphasis{Desbloquear estado (Lock error)}: \markdownRendererCodeSpan{terraform force-unlock <LOCK\markdownRendererUnderscore{}ID>}\markdownRendererUlItemEnd 
...
{}\markdownRendererUlBeginTight
\markdownRendererUlItem \markdownRendererStrongEmphasis{Ver progreso de instalación inicial y descarga de imagen}: \markdownRendererCodeSpan{sudo tail -f /var/log/cloud-init-output.log}\markdownRendererUlItemEnd 
\markdownRendererUlEndTight \markdownRendererInterblockSeparator
{}
\markdownRendererSectionEnd \markdownRendererSectionBegin
